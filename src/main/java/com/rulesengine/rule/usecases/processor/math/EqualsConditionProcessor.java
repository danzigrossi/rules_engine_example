...
public class EqualsConditionProcessor extends BaseMathConditionProcessor implements ConditionInterface {

	private static final Logger LOGGER = LoggerFactory.getLogger(EqualsConditionProcessor.class);
